...
type
  ...
  public
    { Public declarations }
    function RetornaDadosConsulta(Filtro: String; var Erro: String): String;virtual;
  end;
var
...
function TdmBaseConsulta.RetornaDadosConsulta(Filtro: String; var Erro: String): String;
var
  Retorno: TJSONObject;
  Dados: TJSONArray;
  Cliente: TJSONObject;
